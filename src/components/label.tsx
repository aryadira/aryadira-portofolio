...
export default function Label({ type, src, children, ...props }: Label) {
  return (
    <div
      ...
      <Image src={`/icons/${type == "image" ? src : "dot.png"}`} width={type == "image" ? 17 : 10} height={type == "image" ? 0 : 10} alt='dot' />
      {children}
    </div>
  );
}
