            ...
            <div className='card-project border border-[#E3E3E3] bg-[#FAFAFC] shadow-[0_10px_30px_rgba(0,0,0,0.05)] rounded-[50px] mb-10 relative'>
              <div className='container px-[100px] pt-[50px]'>
                ...
                <div className='image-project px-0 pt-8 relative'>
                  ...
                  <div className='w-full stack-project bg-white-transparent absolute bottom-0 mb-4 flex item-cemter justify-start py-[10px] px-[10px] border border-[#E3E3E3] rounded-full backdrop-blur-md'>
                    {project.stacks.map((stack, index) => (
                      <Label type='image' src={stack.icon} key={index}>
                        {stack.name}
                      </Label>
                    ))}
                  </div>
